...
def Convolution(input_tensor,filters):
    ...
    x = Conv2D(filters=filters,kernel_size=(3, 3),padding = 'same',strides=(1, 1),kernel_regularizer=l2(0.00015))(input_tensor)
    x = Dropout(0.1)(x)
    x= Activation('relu')(x)
...
def model(input_shape):
    ...
    dense_1 = Dense(64,activation='relu')(flatten) #ändrade från relu på alla
