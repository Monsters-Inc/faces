...
def model():
    ...
    drop_7 = Dropout(0.2)(dense_3)
    
    output_1 = Dense(1,activation="sigmoid",name='women_out')(drop_5) #Women
    output_2 = Dense(1,activation="sigmoid",name='men_out')(drop_6) #Men
    output_3 = Dense(1,activation="relu",name='age_out')(drop_7) #Age
